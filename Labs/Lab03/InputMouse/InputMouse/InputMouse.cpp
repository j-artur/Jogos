...
LRESULT CALLBACK WinProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
        ...
        // desenhar pixels na posição atual do mouse
        SetPixel(hdc, mouseX - 2, mouseY - 1, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 2, mouseY, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 2, mouseY + 1, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 1, mouseY - 2, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 1, mouseY - 1, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 1, mouseY, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 1, mouseY + 1, RGB(255, 0, 0));
        SetPixel(hdc, mouseX - 1, mouseY + 2, RGB(255, 0, 0));
        SetPixel(hdc, mouseX, mouseY - 2, RGB(255, 0, 0));
        SetPixel(hdc, mouseX, mouseY - 1, RGB(255, 0, 0));
