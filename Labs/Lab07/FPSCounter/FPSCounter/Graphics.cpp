...
bool Graphics::Initialize(Window *window)
{
    ...
    if FAILED (D3D11CreateDevice(NULL,                     // adaptador de vídeo (NULL = adaptador padrão)
                                 ...
                                 &context))                // contexto do dispositivo D3D
    {
        ...
        if FAILED (D3D11CreateDevice(NULL, D3D_DRIVER_TYPE_WARP, NULL, createDeviceFlags, NULL, 0, D3D11_SDK_VERSION,
